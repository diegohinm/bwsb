...
/**
 * FUTURE PROVIDER — TwelveData. Not implemented.
 *
 ...
 */
export class TwelveDataMarketDataProviderStub implements MarketDataProvider {
  ...
  async getStatus(): Promise<MarketDataProviderStatus> {
    return {
      ...
      source: "twelvedata",
      message: "TwelveData provider is not implemented yet — serving demo data.",
      updatedAt: new Date().toISOString(),
    };
  }

  async getQuote(_symbol: string): Promise<MarketQuote> {
    throw new Error("TwelveData provider not implemented");
  }
...
export const twelvedataMarketDataProvider = new TwelveDataMarketDataProviderStub();
